## This file is the constraints file for the Mars Rover
## Minor Project. It is based on the general .xdc for
...
## LEDs
set_property PACKAGE_PIN U16 [get_ports {turn_count_out[0]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {turn_count_out[0]}]
set_property PACKAGE_PIN E19 [get_ports {turn_count_out[1]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {turn_count_out[1]}]
